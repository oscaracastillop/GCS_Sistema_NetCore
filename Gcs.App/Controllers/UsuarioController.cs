...
using AutoMapper;
using Newtonsoft;
using Gcs.App.Models.ViewModels;
using Gcs.App.Utilidades.Response;
    ...
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Crear([FromForm]IFormFile foto, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                string urlPantillaCorreo = $"{this.Request.Scheme}://{this.Request.Host}/Plantilla/EnviarClave?correo=[correo]&clave=[clave]";

                Usuario usuario_creado = await _usuarioService.Crear(_mapper.Map<Usuario>(vmUsuario), fotoStream, nombreFoto, urlPantillaCorreo);
