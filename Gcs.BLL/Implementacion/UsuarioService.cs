...
namespace Gcs.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<Usuario> ObtenerPorCredenciales(string correo, string clave)
        {
            ...
            Usuario usuario_encontrado = await _repositorio.Obtener(u => u.Correo.Equals(correo) && u.Clave.Equals(clave));
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (!correo_enviado)
                    throw new TaskCanceledException("Tenemos problemas. Por favot inténtalo de nuevo más tarde");
