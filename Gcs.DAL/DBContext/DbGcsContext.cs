...
namespace Gcs.DAL.DBContext;

public partial class DbGcsContext : DbContext
{
    public DbGcsContext()
    {
    }

    public DbGcsContext(DbContextOptions<DbGcsContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C27A0A3DB");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F1951DBF0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4831F22AB9F");
            ...
            entity.HasOne(d => d.IdMenuPadreNavigation).WithMany(p => p.InverseIdMenuPadreNavigation)
                ...
                .HasConstraintName("FK__Menu__idMenuPadr__239E4DCF");
        });

        modelBuilder.Entity<Negocio>(entity =>
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107BD5A1313");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E9C50A6BC");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132168F520B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F769AC1A8F4");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D85E9CAA3B");
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                ...
                .HasConstraintName("FK__RolMenu__idMenu__2B3F6F97");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMenu__idRol__2A4B4B5E");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE231A6593");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A69E823576");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C6C45D4B");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__3E52440B");
